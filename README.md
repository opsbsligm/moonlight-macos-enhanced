...
[![Release](https://img.shields.io/badge/release-v1.3.9-blue)](https://github.com/skyhua/Moonlight-macOS/releases/tag/v1.3.9)
...
### 方式一：下载 DMG（推荐）
1. 从 [Releases](../../releases) 下载最新 `Moonlight-macOS-v1.3.9.dmg`
...
每个版本通过 Git annotated tag 标记（如 `v1.3.9`），详见 [CHANGELOG.md](CHANGELOG.md)。
